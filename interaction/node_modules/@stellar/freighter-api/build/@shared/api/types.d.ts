...
export declare type MigratableAccount = Account & {
    keyIdIndex: number;
};
...
export declare type AssetType = Types.AssetBalance | Types.NativeBalance | TokenBalance;
...
export declare type MigratedAccount = BalanceToMigrate & {
    newPublicKey: string;
    isMigrated: boolean;
};
declare global {
